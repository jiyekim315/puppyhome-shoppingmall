...
<% if(id!=null){%>
    <div class="headerbox">
        <div class="menubox">
            ...
            <div class="memberbox">
                 <a href="mypagemain.shop"><%=id %> 님</a> | <a href="member_logout.shop">로그아웃</a> <!-- a태그 링크 변경하여 마이페이지/로그아웃 구현 -->
            </div>
            <div class="navbarbox">
               <div id="dropdownbox">
            ...
            <div class="searchbox">
                <form action="http://localhost:8046/MVC/page/util/company_introduce.jsp" target="_blank" method="POST">
      ...
      <% if(id.equals("admin")){%> <%-- 관리자 일때 --%>
       <div class="headerbox">
        <div class="menubox">
            ...
            <div class="memberbox">
                <a href="adminMain.shop"><%=id %> 님</a> | <a href="member_logout.shop">로그아웃</a> <!-- a태그 링크 변경하여 회원가입/로그인 구현 -->
            </div>
            <div class="navbarbox">
               <div id="dropdownbox">
                    <button id="dropbtn" value="강아지 식품" onclick="location='puppy_product.shop'">사료</button>
