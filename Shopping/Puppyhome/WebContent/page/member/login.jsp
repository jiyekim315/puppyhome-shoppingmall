...
<%
    ...
    */
	...
	<div class="wrap">
		...
		<form method="post" action="member_login_ok.shop" onsubmit="return login_check();">
		...
		<h1>로그인</h1>
			...
			<div class="forgot-username">
				<a href="member_find_id.shop">아이디 찾기</a> | <a href="member_find_pw.shop">비밀번호 찾기</a>
			</div>
		...
		<div class="signup">
			<p>계정이 없으신가요? <a href="member_join.shop">회원가입</a></p>
		</div>
	</div>
	</form>
	<%-- top버튼 삭제 X --%>
