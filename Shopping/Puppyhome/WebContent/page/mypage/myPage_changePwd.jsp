...
<aside>
	<nav>
		<ul>
			...
			<li><a href="changepwd.shop" class="liList" style="color: #FC5400; font-weight: bold;">비밀번호 변경</a></li>
			<li><a href="user_withdrawal.shop" class="liList">회원탈퇴</a></li>
			<li style="margin-bottom: 30px;"><a href="updateaddr.shop" class="liList">배송지 관리</a></li>
	...
	<div class="innerWrap">
		...
		<section class="notice">
			...
			<form method="post" action="changepwd_ok.shop" onsubmit="return pwd_check();">
			<div class="page-title">
			<b style="text-align: left; font-size: 20px;">비밀번호 변경</b>
			</div>
			<br>
				<table>
					<!--현재 비밀번호 -->
					<tr>
						...
						<td class="td-inputInfo"
							style="border-top-color: black; border-top-style: solid; border-top-width: 3px;">
							<input type="password" name="user_pwd" id="user_pwd" size="70">
						</td>
					</tr>
					...
					<!--새 비밀번호 -->					
						<tr>
						<th rowspan="2" class="th-list">새 비밀번호</th>
						<td class="td-inputInfo"><input type="password" name="new_pwd" id="new_pwd"
							size="70"></td>
					</tr>
		...
		<%--			<!--새 비밀번호  확인-->
				...
				<input id="changePwdBtn" type="submit" value="확인">
