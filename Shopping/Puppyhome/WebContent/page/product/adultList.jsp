...
<link rel="stylesheet" type="text/css"
	href="<%=request.getContextPath()%>/page/product/css/adultList.css" />
						...
						<div
							...
							<h2>
								<span class="menuImg"> <a href="#"
									onclick="location='puppy_product.shop'"> <img
										src="<%=request.getContextPath()%>/images/Feed.png"
										width="200px">
								</a> <br> 사료
								</span>
							</h2>
					...
					<div class="product_kind_button">
						<ul class="menuCategory">
							...
							<li style="display:;"
								...
								<a href="#" onclick="location='puppy_product.shop'">퍼피 <span
