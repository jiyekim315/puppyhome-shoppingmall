...
<link rel="stylesheet" type="text/css" href="<%=request.getContextPath()%>/page/product/css/gumList.css"/>
...
<%-- 본문시작 --%>
					<div class="product_kind">
						...
						<div
							...
							<h2>
								<span class="menuImg">
									<a href="#"  onclick="location='gum_product.shop'">
									<img src="<%=request.getContextPath()%>/images/Gansik.png" width="200px">
									</a>
									<br>
									간식
								</span>
						...
						<div class="product_kind_button">
							<ul class="menuCategory">
								...
								<a href="#" onclick="location='gum_product.shop'">껌간식
