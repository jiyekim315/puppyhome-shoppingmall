...
<link rel="stylesheet" type="text/css" href="<%=request.getContextPath()%>/page/product/css/omega3List.css"/>
...
<%-- 본문시작 --%>
					<div class="product_kind">
						...
						<div
							...
							<h2>
								<span class="menuImg">
									<a href="#" onclick="location='probio_product.shop'">
						...
						<div class="product_kind_button">
							<ul class="menuCategory">
								...
								<a href="#" onclick="location='probio_product.shop'">유산균
								...
								<li style="display:;"
									...
									href="#" onclick="location='omega3_product.shop'">오메가3 <span
