...
<link rel="stylesheet" type="text/css" href="<%=request.getContextPath()%>/page/product/css/seniorList.css"/>
...
<%-- 본문시작 --%>
					<div class="product_kind">
						...
						<div
							...
							<h2>
								<span class="menuImg">
									<a href="#" onclick="location='puppy_product.shop'">
									<img src="<%=request.getContextPath()%>/images/Feed.png" width="200px">
									</a>
									<br>
									사료
								</span>
					...
					<div class="product_kind_button">
							<ul class="menuCategory">
								...
								<a href="#" onclick="location='puppy_product.shop'">퍼피
								...
								<li style="display:;"
									...
									href="#"  onclick="location='adult_product.shop'">어덜트 <span
								...
								<li style="display:;"
									class="xans-element- xans-product xans-product-displaycategory  xans-record-"><a
									href="#" onclick="location='senior_product.shop'">시니어 <span
										class="count displaynone">()</span></a>
  ...
  <ul class="product_list list">
    ...
    <li class="product_item" onclick="location='product_dsc.shop?product_title=${p.product_title}'">
      ...
      <div class="product_image">
        <a href="#"><img src="<%=request.getContextPath()%>/images/${fn:split(p.product_cont,',')[0]}"  alt="상품 사진"></a>
